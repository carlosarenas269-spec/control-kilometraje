                ...
                if not df_c.empty:
                    ...
                    for _, row in df_c.iterrows():
                        ...
                        if num_cli and num_cli.lower() != 'nan':
                            ...
                            # Leer latitud y longitud asegurando formato numérico
                            try:
...
# Cargar desde disco al iniciar la app (una sola vez)
                            ...
                            if not df.empty:
                                if tipo_carga == "Lista de Operadores":
                                    ...
                                    if lista_c:
                                        ...
                                        st.session_state.db_clientes = nueva_db
                                        guardar_catalogos_en_disco()
                                        st.success("✅ Base de clientes y coordenadas importadas correctamente.")
                                        st.rerun()
                            else:
            ...
            with col_m3:
                ...
                if st.button("🗑️ Eliminar de Catálogo"):
                    if item_eliminar:
                        ...
                        # Guardar inmediatamente en disco para que no vuelvan a aparecer
                        guardar_catalogos_en_disco()
