...
ARCHIVO_INCIDENCIAS = "registros_incidencias.xlsx" # Nuevo archivo para incidencias
...
# ==========================================
# MÓDULO NUEVO: CAPTURA RÁPIDA DE INCIDENCIAS EN SIDEBAR
# ==========================================
...
# Si es admin, mostrar opción de descarga del reporte de incidencias en el menú admin de la etapa 1 o sidebar
if es_admin:
    if os.path.exists(ARCHIVO_INCIDENCIAS):
